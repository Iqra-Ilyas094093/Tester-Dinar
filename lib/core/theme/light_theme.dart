...
class LightTheme {
  static ThemeData get theme {
    return ThemeData(
      ...
      // ✅ FIX: AppBar uses white background with dark text/icons
      appBarTheme: AppBarTheme(
        backgroundColor: AppColors.white,
        foregroundColor: AppColors.nearBlack,
        elevation: 0,
        centerTitle: false,
        // ✅ FIX: dark icons on light status bar
        ...
        actionsIconTheme: const IconThemeData(color: AppColors.nearBlack),
      ),
      ...
      // ✅ FIX: BottomNav uses white background with dark unselected icons
      ...
      // ✅ FIX: Icon theme uses dark colors for light mode
